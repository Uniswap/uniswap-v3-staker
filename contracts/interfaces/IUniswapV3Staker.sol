...
interface IUniswapV3Staker is IERC721Receiver, IMulticall {
    ...
    /// @return totalRewardAllocated The amount of reward token was allocated to incentive campaign
    /// @return totalSecondsClaimedX128 Total liquidity-seconds claimed, represented as a UQ32.128
    /// @return numberOfStakes The count of deposits that are currently staked for the incentive
    /// @return success True if the incentive accrues sufficient rewards to cover distribution
